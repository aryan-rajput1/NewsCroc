...
export class News extends Component {
    ...
    fetchMoreData = async () => {
        ...
        // this.props.setProgress(10);
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=2a557c50c0434edf9b91d2281ba037be&page=${this.state.page+1}&pagesize=20`;
        ...
        return (
            <>
                ...
                <InfiniteScroll
                    ...
                    loader={this.state.loading && <Spinner animation="border" role="status">
                            ...
                            {this.state.article.map((element) => {
                                return <div className="col-md-3 my-3 " key={element.url} >
                                    <NewsItem title={element.title ? element.title.slice(0, 40) : "....."}
                                        ...
                                        article={element.article} Newsurl={element.url} author={element.author}
